                ...
                <form action="{{ route('catalogo.colores.store') }}" method="POST" class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div class="mt-4 p-4 rounded-xl border-2 border-gray-200 dark:border-slate-700 flex items-center gap-4 bg-gray-50 dark:bg-slate-900/60">
                            ...
                            <div>
                                <p class="font-semibold text-gray-800 dark:text-slate-200" id="previewNombre">{{ old('nombre', 'Nuevo color') }}</p>
                                <p class="text-sm font-mono text-gray-500 dark:text-slate-400" id="previewHex">{{ old('codigo_hex', '#3b82f6') }}</p>
                                <span class="inline-block mt-1 px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300">Vista previa</span>
                            </div>
                        </div>
                    </div>
