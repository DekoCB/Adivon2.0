        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-lg overflow-hidden">
                ...
                <form action="{{ route('catalogo.marcas.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-5">
                    ...
                    {{-- Logo --}}
                    <div>
                        <label for="logo" class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Logo de la Marca</label>
                        <div class="flex items-center gap-4">
                            <div id="logoPreviewContainer" class="hidden">
                                <img id="logoPreview" src="" alt="Vista previa"
                                     class="h-20 w-20 object-contain rounded-lg border-2 border-gray-300 dark:border-slate-600 p-1">
                            </div>
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-xs text-gray-400 dark:text-slate-500">JPG, PNG, WEBP, SVG. Máx 2MB</p>
                            </div>
                        </div>
                        @error('logo')
