                ...
                <form action="{{ route('catalogo.unidades.update', $unidade) }}" method="POST" class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="descripcion" id="descripcion" rows="2"
                                  ...
                                  class="w-full px-4 py-2.5 border border-gray-300 dark:border-slate-600 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">{{ old('descripcion', $unidade->descripcion) }}</textarea>
                    </div>
