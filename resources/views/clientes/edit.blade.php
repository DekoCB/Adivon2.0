...
<div class="max-w-2xl mx-auto">
            <div class="flex items-center mb-6">
                <a href="{{ route('clientes.index') }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-800 mr-4"><i class="fas fa-arrow-left"></i></a>
                <h2 class="text-2xl font-bold text-gray-800 dark:text-slate-200">Editar Cliente</h2>
            </div>
                ...
                <form action="{{ route('clientes.update', $cliente) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="tipo_documento" class="w-full rounded-lg border-gray-300 dark:border-slate-600 shadow-sm">
                        ...
                        <div>
                            ...
                            <input type="text" name="numero_documento" maxlength="11" required
                                   class="w-full rounded-lg border-gray-300 dark:border-slate-600 shadow-sm @error('numero_documento') border-red-500 @enderror"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nombre" required
                                   class="w-full rounded-lg border-gray-300 dark:border-slate-600 shadow-sm @error('nombre') border-red-500 @enderror"
                                   value="{{ old('nombre', $cliente->nombre) }}">
                            @error('nombre') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Dirección</label>
                            <input type="text" name="direccion" class="w-full rounded-lg border-gray-300 dark:border-slate-600 shadow-sm" value="{{ old('direccion', $cliente->direccion) }}" placeholder="Av. / Jr. / Calle...">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Departamento</label>
                            <select name="departamento" class="w-full rounded-lg border-gray-300 dark:border-slate-600 shadow-sm bg-white dark:bg-slate-800">
                        ...
                        <div>
                            ...
                            <input type="text" name="provincia" maxlength="100" class="w-full rounded-lg border-gray-300 dark:border-slate-600 shadow-sm" value="{{ old('provincia', $cliente->provincia) }}" placeholder="Provincia">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Distrito</label>
                            <input type="text" name="distrito" maxlength="100" class="w-full rounded-lg border-gray-300 dark:border-slate-600 shadow-sm" value="{{ old('distrito', $cliente->distrito) }}" placeholder="Distrito">
                        </div>
                        <div>
                            ...
                            <input type="text" name="ubigeo" maxlength="6" inputmode="numeric" pattern="\d{0,6}"
                                   class="w-full rounded-lg border-gray-300 dark:border-slate-600 shadow-sm font-mono" value="{{ old('ubigeo', $cliente->ubigeo) }}" placeholder="Ej: 150101">
                        ...
                        <div>
                            ...
                            <input type="text" name="telefono" maxlength="20" class="w-full rounded-lg border-gray-300 dark:border-slate-600 shadow-sm" value="{{ old('telefono', $cliente->telefono) }}">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Email</label>
                            <input type="email" name="email" class="w-full rounded-lg border-gray-300 dark:border-slate-600 shadow-sm" value="{{ old('email', $cliente->email) }}">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Estado</label>
                            <select name="estado" class="w-full rounded-lg border-gray-300 dark:border-slate-600 shadow-sm">
                    ...
                    <div class="flex justify-end gap-3 mt-6">
                        <a href="{{ route('clientes.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 dark:text-slate-200 font-semibold py-2 px-6 rounded-lg">Cancelar</a>
