            ...
            <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/60">
                ...
                <td class="px-6 py-4">
                    <div class="flex items-center">
                        ...
                        @endif
                        <span class="text-sm font-medium text-gray-900 dark:text-slate-100">{{ $producto->nombre }}</span>
                    </div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                    <a href="{{ route('inventario.productos.show', $producto) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-900" title="Ver producto">
