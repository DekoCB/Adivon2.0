...
<div>
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Panorama de cuentas por pagar a proveedores</p>
        </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-5 border-l-4 border-blue-500">
            <div class="flex items-start justify-between">
                <div>
                    <p class="text-xs text-gray-500 uppercase font-medium tracking-wide">Por Pagar</p>
        ...
        <div class="bg-white rounded-2xl shadow-sm p-5 border-l-4 border-green-500">
            <div class="flex items-start justify-between">
                <div>
                    <p class="text-xs text-gray-500 uppercase font-medium tracking-wide">Pagado este mes</p>
        ...
        <div class="bg-white rounded-2xl shadow-sm p-5 border-l-4 border-yellow-500">
            <div class="flex items-start justify-between">
                <div>
                    <p class="text-xs text-gray-500 uppercase font-medium tracking-wide">Próximos 30 días</p>
    ...
    <x-data-table>
        ...
        @forelse($proximosVencimientos as $cuenta)
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-5 py-3.5 text-gray-700 max-w-[220px] truncate">
        ...
        @empty
            <tr>
                <td colspan="5" class="px-6 py-16 text-center">
                    ...
                    <p class="text-gray-500 font-medium">Sin vencimientos en los próximos 7 días</p>
                </td>
            </tr>
        @endforelse
    </x-data-table>
