...
class CompraVentaFlowTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // VentaService::crearVenta() exige una caja abierta del usuario
        // para ventas al contado ya pagadas (Regla crítica de caja).
    ...
    protected function tearDown(): void
    {
        ...
        if (isset($this->caja)) {
            \App\Models\MovimientoCaja::where('caja_id', $this->caja->id)->delete();
            $this->caja->delete();
        }
